...
const HomePage = () => {
  const { filteredProperties, loading, applyFilters, toggleWatchlist } =
    useProperties();
        ...
        <div className="relative rounded-2xl overflow-hidden mb-8">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-gray-900/80 to-gray-900/40 flex flex-col justify-center p-8">
            ...
            <p className="text-lg text-gray-200 mb-6 max-w-xl">
              Buy, sell, and manage properties with the security and
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-gray-800 rounded-xl p-6 transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
            ...
            <p className="text-gray-300">
              Each property is represented as a unique token on the blockchain,
              ensuring verifiable ownership and history.
            </p>
          </div>
          ...
          <div className="bg-gray-800 rounded-xl p-6 transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
            ...
            <p className="text-gray-300">
              Connect with buyers and sellers worldwide without intermediaries,
          ...
          <div className="bg-gray-800 rounded-xl p-6 transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
            ...
            <p className="text-gray-300">
              Smart contracts ensure transparent, secure transactions with
              escrow functionality and automated verification.
            </p>
          </div>
        </div>
      </div>
